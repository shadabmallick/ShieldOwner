...
public class AdapterActivity extends RecyclerView.Adapter<AdapterActivity.MyViewHolder> {
    ...
    public AdapterActivity(Context context,ArrayList<String> aList) {
        this.aList = aList;
    ...
    @Override
    public AdapterActivity.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_activity, parent, false);

        AdapterActivity.MyViewHolder vh = new AdapterActivity.MyViewHolder(v);
        return vh;
    }
