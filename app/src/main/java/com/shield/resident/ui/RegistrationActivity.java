...
public class RegistrationActivity extends AppCompatActivity {
    ...
    Spinner edt_city_name,edt_complex_name,edt_block_name,edt_flat_no;
        String city_id,item,complex_id,block_name,flat_no, flat_id,complex_name;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rel_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(city_id!=null
                    ...
                    Intent register_next=new Intent(getApplicationContext(),
                            RegisterNext.class);
                    ...
                    register_next.putExtra("flat_id", flat_id);
        ...
        rel_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent register_next=new Intent(getApplicationContext(), Login.class);
                    startActivity(register_next);
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                  ...
                  if(status.equals("1")) {
                      ...
                      dataadpater3 = new ArrayAdapter(RegistrationActivity.this,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("1")) {
                        ...
                        dataadapter4 = new ArrayAdapter(RegistrationActivity.this,
