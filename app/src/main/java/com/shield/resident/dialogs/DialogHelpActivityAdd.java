...
public class DialogHelpActivityAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date_picker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getApplicationContext(), R.style.datepicker,
        ...
        radioSex.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            Toast.makeText(getApplicationContext(),
                    radio_value, Toast.LENGTH_SHORT).show();
        ...
        date_picker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(DialogHelpActivityAdd.this, R.style.datepicker,
                        datePickerListener, mYear, mMonth, mDay).show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status.equals("1")) {
                        ...
                        ArrayAdapter dataAdapter1 = new ArrayAdapter(getApplicationContext(),
    ...
    private void gotoContactScreen(){
        ...
        Intent intent = new Intent(DialogHelpActivityAdd.this, ContactList.class);
